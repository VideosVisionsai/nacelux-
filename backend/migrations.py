...
JSON_COLUMNS={'companies':{'secondary_nace_codes'},'business_signals':{'signal_value'},'opportunity_scores':{'breakdown'},'audit_logs':{'metadata'},'digital_checks':{'details'},'seo_audits':{'findings'},'territories':{'municipalities'},'resa_sync_runs':{'metadata'},'nace_versions_official':{'metadata'},'nace_import_runs':{'metadata'},'website_discovery_runs':{'metadata'},'website_candidates':{'evidence'},'google_business_profiles':{'raw_data'},'digital_checks':{'details','evidence'},'seo_audits':{'findings'},'business_signals':{'signal_value','evidence'},'people_engine_runs':{'metadata'},'professional_profiles_public':{'evidence'},'business_signal_runs':{'metadata'}}
